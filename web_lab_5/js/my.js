		...
		if(userName !== null && userName !== '' && reviewText !==null && reviewText !== '') {
			...
			document.getElementById("send_user_name").value = "";
 			document.getElementById("send_review").value = "";
		   	...
		   	alert("Вам необхідно заповнити поле з ім'ям та прізвищем, а також опис");
		}
...
$(function() {
    $('#send_news_button').click(function(){
		...
		var newsShortText = document.getElementById('news_short_text_admin_page').value;
		var newsTitle = document.getElementById('news_title_admin_page').value;

		if(newsContent !== null && newsContent !== '' && newsShortText !==null && newsShortText !== '' && newsTitle !==null && newsTitle !== '' && uploadedImage !==null && uploadedImage !== '') {
			alert("Новина успішно додана!");

			document.getElementById("news_text_admin_page").value = "";
 			document.getElementById("news_short_text_admin_page").value = "";
